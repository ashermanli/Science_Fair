        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
			...
			<?php
				...
				$studentReg = '<li> <a href="StudentRegistration.php"> <i class="icon-grid"></i>Register Students </a></li>';
				$judgeReg = '<li> <a href="JudgeRegistration.php"> <i class="fa fa-bar-chart"></i>Register Judges </a></li>';
